...
const PageFooter = () => {
  return (
    <footer className='bg-zinc-900'>
        <div className='container px-4 md:px-5 mx-auto grid grid-cols-2 md:grid-cols-3 py-4'>
            <div className='col-span-1 text-amber-200 flex justify-start'>
            <div>
           ...
           <div className='col-span-2 md:col-span-1 text-amber-200 md:flex justify-end'>
                <div>
